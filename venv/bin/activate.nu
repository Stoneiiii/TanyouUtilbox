...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/media/stone/data/myproject/java/utilbox/utilbox/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/media/stone/data/myproject/java/utilbox/utilbox/venv/bin/deactivate.nu'
